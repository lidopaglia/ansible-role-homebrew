...
[![Build Status](https://travis-ci.org/lidopaglia/ansible-role-homebrew.svg?branch=master)](https://travis-ci.org/lidopaglia/ansible-role-homebrew)
...
See the `tests/local-testing` directory for an example of running this role over Ansible's `local` connection.
